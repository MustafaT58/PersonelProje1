    ...
    public class PersonelController : TemelController
    {
       ...
       //PersonelModel _model= new PersonelModel(); 
        ...
        public IActionResult Guncel(int Id) //Get
        {
            ...
            return View("Genel",_model); //parantez içerisinde _model yazmamızın sebebi sehirId ve ulkeId yi list options şekinde çekecek olmamızdır.
        }
        [HttpPost]
        public IActionResult Guncel(PersonelModel model) //Get
        {
            ...
            return RedirectToAction("Liste"); //parantez içerisinde _model yazmamızın sebebi sehirId ve ulkeId yi list options şekinde çekecek olmamızdır.
        }
        ...
        [HttpPost]
        public IActionResult Sil(PersonelModel model) //Get
        {
            Personel personel = model.Personel;
        ...
        public IActionResult Giris()
        {
            ...
            _model.Ulkeler = Ulkeler();
            _model.Sehirler = Sehirler();
            _model.Baslik = "Yeni Kayıt";
            _model.BtnText = "Kaydet";
            _model.BtnClass = "btn btn-success";
            return View("Genel", _model);
        }
        [HttpPost]
        public IActionResult Giris(PersonelModel model) //Get
        {
            Personel personel = model.Personel;
